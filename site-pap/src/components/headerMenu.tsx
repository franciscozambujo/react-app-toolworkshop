...
export function headerMenuNav(){
    ...
    <div className="size-52 absolute">
        <img src="./img/header.png" alt="Logotipo" />
    </div>
      <NavigationMenu className="mx-auto">
        <NavigationMenuList>
          <NavigationMenuItem>
            <NavigationMenuTrigger className="bg-green-100 text-lg">Quem Somos</NavigationMenuTrigger>
            <NavigationMenuContent>
              <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                ...
                <ListItem href="#" title="Porquê escolher a nossa oficina" className="h-48">
          ...
          <NavigationMenuItem className="grid grid-flow-col auto-cols-max">
            <NavigationMenuTrigger className="bg-green-100 text-lg">Serviços</NavigationMenuTrigger>
            <NavigationMenuContent>
              <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                <li className="row-span-3">
                  <NavigationMenuLink asChild>
      ...
      <button
        className="absolute right-6 top-3 mb-2 font-medium bg-green-100 text-lg" onClick={() => window.location.href = "../login.html"}>
        Login
      </button>
    </header>
    )
